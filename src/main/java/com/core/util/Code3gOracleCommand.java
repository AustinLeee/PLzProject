...
public class Code3gOracleCommand extends Code3gDbCommand {

	private OraclePreparedStatement statement;
	public Code3gOracleCommand(String commandText, DbParameter[] dbParameters, ParasValueListInfo parasValueListInfo) throws Exception {
